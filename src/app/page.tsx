      ...
      >
        <div className="mx-auto max-w-7xl">
          <div className="flex items-center justify-between rounded-full border border-white/10 bg-black/60 backdrop-blur-xl px-6 py-3">
            ...
            <button
              onClick={() => 
              window.open("https://wa.me/919329441312?text=Hi%20I'm%20interested%20in%20your%20web%20development%20services", "_blank");
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <div className="font-medium">+91 9329441312</div>
                </div>
              </div>
              <div className="flex items-center gap-4">
                <div className="w-12 h-12 rounded-full bg-white/5 flex items-center justify-center">
